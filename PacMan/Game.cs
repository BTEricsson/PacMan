...
namespace PacMan
{
    public class Game
    {
        ...
        {
            return _levels.Where(L => L.Number == level).FirstOrDefault();
        }

        private Level FirstLevel()
        {
            Level level = new Level(1, new Point(15,6), new Point(2,2), new Point(29,2), new Point(2,18), new Point(29,18));
            ...
            wallSketchs.AddRange(WallUppCornerLeft(new Point(4, 4), 4, 3));

            //Coner Left bottom inner 
            wallSketchs.AddRange(WallDownCornerLeft(new Point(4, 13), 3, 4));

            //coner right top inner
            wallSketchs.AddRange(WallUppCornerRight(new Point(24, 4), 4, 3));

            //coner right bottom inner
            wallSketchs.AddRange(WallDownCornerRight(new Point(27, 13), 4, 3));
            ...
            coinSketchs.AddRange(CoinsUpperLeftCorner(new Point(5, 5), 3, 2));
            // bottom left corner
            coinSketchs.AddRange(CoinsDownLeftCorner(new Point(5, 13), 3, 2));
            // top right corner
            coinSketchs.AddRange(CoinsUpperRightCorner(new Point(24, 5), 3, 2));

            coinSketchs.AddRange(CoinsDownRightCorner(new Point(26, 13), 3, 2));
        ...
        private List<Sketch> Wallhorizontal(Point startPoint, int bolcks)
        {
            var sketchs = new List<Sketch>();
        ...
        private List<Sketch> WallVertical(Point startPoint, int bolcks)
        {
            var sketchs = new List<Sketch>();
